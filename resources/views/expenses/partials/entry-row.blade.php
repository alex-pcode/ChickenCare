<tr id="expense-{{ $expense->id }}" class="expenses__row">
    ...
    <td class="data-table__cell">{{ \App\Enums\ExpenseCategory::tryFrom((string) $expense->category)?->label() ?? ucfirst((string) $expense->category) }}</td>
    ...
    <td class="data-table__cell data-table__actions">
        <button type="button" class="btn btn--sm btn--secondary"
            ...
            hx-swap="outerHTML"
            aria-label="{{ __('expenses.actions.edit_aria_label', ['date' => $expense->date->translatedFormat('d. M Y.')]) }}">
        ...
        <button type="button"
            ...
            aria-label="{{ __('expenses.actions.delete_aria_label', ['date' => $expense->date->translatedFormat('d. M Y.')]) }}">
